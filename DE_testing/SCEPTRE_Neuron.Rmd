...
##Reading in data and creating a seurat object

data_dir <- '/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/neuron_filtered_feature_bc_matrix/'
list.files(data_dir)
...
matrix_dir = "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/neuron_filtered_feature_bc_matrix/"
...
genes <- read.table("/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/neuron_filtered_feature_bc_matrix/features.tsv.gz", fill = TRUE, stringsAsFactors = FALSE) %>% 
...
Sorted_Cells <- lane %>% 
  filter(lane < 3)
Sorted_Cells$sorted<- "sorted"

Not_Sorted_Cells <- lane %>% 
  filter(lane > 2)
Not_Sorted_Cells$sorted <- "not_sorted"

sorted <- rbind(Sorted_Cells, Not_Sorted_Cells)

##Make both lane and cell type factors

lane <- as.factor(lane$lane)  
sorted <- as.factor(sorted$sorted)
...
write_csv(Right_Sided_Calibration_Result, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Right_Sided_Calibration_Result.csv")
write_csv(Right_Sided_Discovery_Result, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Right_Sided_Discovery_Result.csv")
write_csv(Right_Sided_Test_Discovery_Set, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Right_Sided_Test_Discovery_Set.csv")
...
write_csv(Two_Sided_Calibration_Result, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Two_Sided_Calibration_Result.csv")
write_csv(Two_Sided_Discovery_Result, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Two_Sided_Discovery_Result.csv")
write_csv(Two_Sided_Test_Discovery_Set, "/Users/troymcdiarmid/Documents/Neurohub/SCEPTRE_NBT_Analysis/Neuron_Results/Two_Sided_Test_Discovery_Set.csv")
