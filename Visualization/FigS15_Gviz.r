...
##Making a visualization of the effects of each gRNA at each target locus (TBR1 K562)
...
Hit_Track <- DataTrack(data = Hits$plot_pval, start = Hits$start, end = Hits$end, chromosome = chr, genome = gen, groups = factor(df2_label,levels = c(df1_label, df2_label)), col = "#56B4E9", legend=FALSE, ylim = c(0,160), col.axis = "black", background = "white", fontcolor.title = "black", name = "-log10(P-values)", background.title = "white", col.frame = "white", fill = "white")
Non_Hit_Track <- DataTrack(data = Non_Hits$plot_pval, start = Non_Hits$start, end = Non_Hits$end, chromosome = chr, genome = gen, groups = factor(df1_label,levels = c(df1_label, df2_label)), col = "#999999", legend=FALSE, ylim = c(0,160), col.axis = "black", background = "white", fontcolor.title = "black", name = "-log10(P-values)", background.title = "white", col.frame = "white", fill = "white")
...
overlapTracks <- OverlayTrack(trackList = list(Non_Hit_Track, Hit_Track), legend= TRUE, background.title = "white", col.frame = "white", fill = "white")
...
Hit_Track <- DataTrack(data = Hits$plot_pval, start = Hits$start, end = Hits$end, chromosome = chr, genome = gen, groups = factor(df2_label,levels = c(df1_label, df2_label)), col = "#56B4E9", legend=FALSE, ylim = c(0,39), col.axis = "black", background = "white", fontcolor.title = "black", name = "-log10(P-values)", background.title = "white", col.frame = "white", fill = "white")
Non_Hit_Track <- DataTrack(data = Non_Hits$plot_pval, start = Non_Hits$start, end = Non_Hits$end, chromosome = chr, genome = gen, groups = factor(df1_label,levels = c(df1_label, df2_label)), col = "#999999", legend=FALSE, ylim = c(0,39), col.axis = "black", background = "white", fontcolor.title = "black", name = "-log10(P-values)", background.title = "white", col.frame = "white", fill = "white")

overlapTracks <- OverlayTrack(trackList = list(Hit_Track, Non_Hit_Track), legend= TRUE, background.title = "white", col.frame = "white", fill = "white")
...
##Making a visualization of the effects of each gRNA at each target locus
