...
write_csv(Primary_Targeting_Results, "/net/shendure/vol10/www/content/members/CRISPRa_QTL_website/public/data/neuron_data/differential_gene_expression_testing_outputs/Neuron_1Mb_DE/Neuron_Primary_Targeting_Results.csv")
...
ggplot(Primary_Targeting_Results, aes(reorder(Test_ID, avg_log2FC), y = 1, fill= avg_log2FC)) + 
  ...
  scale_fill_gradientn(colours = c("#999999", "white", "dodgerblue2"),
                       values = scales::rescale(c(-0.7, -0.1, 0, 0.05, 1.15)))
...
write_csv(Hits, "/net/shendure/vol10/www/content/members/CRISPRa_QTL_website/public/data/neuron_data/differential_gene_expression_testing_outputs/Neuron_1Mb_DE/Neuron_Hits.csv")
...
##Determining how many hits upregulated their expected target gene
